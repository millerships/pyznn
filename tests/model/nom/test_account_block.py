...
class TestAccountBlock:
    json_data = {
        ...
        "signature": "hrQwfpdEYTjoLV9yzEppeky2Y/9T1x760vQPL6NLgD+cn0XD1+F/dOcSwyhg8RxjHWMN6MvD2NnTAX7N+5aCBQ==",  # noqa
    }

    hash = "3835082b4afb76971d58d6ad510e7e91f3bb0d41912fac4ec4cfef7bd7bbea73"

    def test_get_hash(self):
        ab = AccountBlock.from_json(self.json_data)
        assert str(ab.get_hash()) == self.hash
